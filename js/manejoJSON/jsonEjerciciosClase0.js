const array = [
  ...
  newArray.forEach(element => {
    if (element.activo){
        ...
        element.intereses.unshift("CSS/Html")
    }else{
        element.activo = true
        element.intereses.push("JavaScript")
    }
  })

newArray.forEach(element =>
    console.log("Nombre: " + element.nombre + ",    Activo:" + element.activo + ",    Intereses: " + element.intereses )
    )
